...
//////////////////////////////////////////////✨C A S E ✨//////////////////////////////////////////////
    ...
    case CAPITALIZE:
        if (record->event.pressed) {
    	    SEND_STRING(SS_LGUI("c"));  // Send ⌘ ("c") :: 2025.05.26-19:01
	        SEND_STRING_DELAY("KMcApItAlIze", 25);
	        wait_ms(75);    // 🎹"KMcApItAlIze" :: 2025.05.26-19:01
	    } return false;
